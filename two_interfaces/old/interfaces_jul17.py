...
def interfere(rules: dict, filenamedips, filenamewidths, filenamechisqs, params, fit=True):
    print(f"MID-level running in PID {os.getpid()} (name={__name__})")
    
    tlist, dt, freqList, Elw, eList, tauList, xticks, yticks, transfer_generator, chirp, chirp_params = params
...
def main():
    ...
    filenameBarcLossless = filenamedips + "_lossless_barc_"
    ...
    filenameBarcRealistic = filenamedips + "_realistic_barc_"

    names = [filenameLinLossless,filenameErf1Lossless,filenameErf2Lossless,filenameErf3Lossless,filenameVphLossless, filenameBarcLossless,
             filenameLinRealistic,filenameErf1Realistic,filenameErf2Realistic,filenameErf3Realistic,filenameVphRealistic, filenameBarcRealistic]
    ...
    paramsErf3Lossless = tlist, dt, freqList, Elw, eList, tauList, xticks, yticks, slab_lossless, erf_ch, (b3, s3, w0)
    paramsVphLossless = tlist, dt, freqList, Elw, eList, tauList, xticks, yticks, slab_lossless, step_ch, (50000, w0)
    paramsBarcLossless = tlist, dt, freqList, Elw, eList, tauList, xticks, yticks, slab_lossless, barc_ch, (2*A, w0)
    paramsLinRealistic = tlist, dt, freqList, Elw, eList, tauList, xticks, yticks, slab_transfer, lin_ch, (A, w0)
    paramsErf1Realistic = tlist, dt, freqList, Elw, eList, tauList, xticks, yticks, slab_transfer, erf_ch, (b1, s1, w0)
    paramsErf2Realistic = tlist, dt, freqList, Elw, eList, tauList, xticks, yticks, slab_transfer, erf_ch, (b2, s2, w0)
    ...
    paramsBarcRealistic = tlist, dt, freqList, Elw, eList, tauList, xticks, yticks, slab_transfer, barc_ch, (2*A, w0)

    for k, params in enumerate([paramsLinLossless, paramsErf1Lossless, paramsErf2Lossless, paramsErf3Lossless, paramsVphLossless, paramsBarcLossless,
                   paramsLinRealistic, paramsErf1Realistic, paramsErf2Realistic, paramsErf3Realistic, paramsVphRealistic, paramsBarcRealistic]):
