...
def save_simulation_metadata(output_dir: str, filename: str, params: tuple, Lvals):
...
def interfere(rules: dict, filenamedips, filenamewidths, filenamechisqs, params, fit=True):
    ...
    save_simulation_metadata(os.path.join(directpath,'results', filenamedips), filenamedips+'meta.txt', params, Lvals)
