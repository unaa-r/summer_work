...
srun python -u interfere_long_jul8.py --b 8300.0 --sigma_s 10.0 --output 100ps_s10.0
#srun python -u interfere_long.py --b 7904.761904761905 --sigma_s 10.5 --output 100ps_s10.5
srun python -u interfere_long._jul8py --b 7545.454545454545 --sigma_s 11.0 --output 100ps_s11.0
#srun python -u interfere_long.py --b 7217.391304347826 --sigma_s 11.5 --output 100ps_s11.5
srun python -u interfere_long._jul8py --b 6916.666666666667 --sigma_s 12.0 --output 100ps_s12.0
#srun python -u interfere_long.py --b 6640.0 --sigma_s 12.5 --output 100ps_s12.5
srun python -u interfere_long._jul8py --b 6384.615384615385 --sigma_s 13.0 --output 100ps_s13.0
